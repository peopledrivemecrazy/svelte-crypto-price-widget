    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text(t2_value);
    			t3 = space();
    			add_location(p0, file, 37, 6, 662);
    			add_location(p1, file, 38, 6, 703);
    			attr_dev(div0, "class", "card-text");
    			add_location(div0, file, 36, 5, 632);
    			attr_dev(div1, "class", "card");
    			add_location(div1, file, 35, 4, 608);
    			attr_dev(div2, "class", "col");
    			add_location(div2, file, 34, 4, 586);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 27, 1, 472);
    			add_location(main, file, 26, 0, 464);
    			attr_dev(a, "href", "https://anoram.com");
    			add_location(a, file, 53, 10, 890);
    			add_location(p, file, 53, 1, 881);
    			add_location(br, file, 54, 1, 949);
    			add_location(title, file, 55, 87, 1041);
    			...
    			add_location(path0, file, 55, 119, 1073);
    			...
    			add_location(path1, file, 55, 1763, 2717);
